    ...
    <div className="relative overflow-hidden rounded-lg bg-card border border-border p-6 xl:p-8 animate-slide-up group hover:border-primary/30 transition-colors">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-2">
          <p className="text-base xl:text-2xl font-semibold uppercase tracking-wider text-muted-foreground">{title}</p>
          <p className="text-4xl xl:text-6xl font-bold font-mono text-foreground">{value}</p>
          {subtitle && <p className="text-sm xl:text-base text-muted-foreground">{subtitle}</p>}
        </div>
